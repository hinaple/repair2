...
기본적으로 내부 asset은 원래 asset size를 사용합니다.

Asset이 `<repair-asset>`의 한 축 또는 양쪽 축을 기준으로 sizing해야 할 때는 `sizing`을 사용하세요.

| `sizing` | Behavior                                                                   |
| -------- | -------------------------------------------------------------------------- |
| unset    | 원래 asset size를 사용합니다.                                              |
...
| `both`   | 내부 asset을 `<repair-asset>`의 width와 height 모두에 맞춰 늘립니다.       |
